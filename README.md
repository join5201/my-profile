...
단순한 소개글을 넘어, 방문한 사람이 응원 메시지를 남기고
실시간으로 쌓이는 것을 볼 수 있는 인터랙티브 자기소개 페이지입니다.

## 왜 만들었나요?

HTML/CSS/JS의 브라우저 렌더링 동작 원리를 직접 구현하며 익히기 위해
만들었습니다. 특히 JavaScript가 DOM을 어떻게 변경하는지,
React의 Virtual DOM이 어떻게 최적화하는지를 이 프로젝트로 체감했습니다.
